...
//     const date = new Date();
//     date.setTime(date.getTime() + (365))
//     let expires = "expires=" + date.toUTCString()
//     document.cookie = sName + "=" + sValue + "=" + sClass + ";" + expires + ";path=/; max-age=31536000; SameSite=None; Secure;"
...
const setCookie = (sName, sValue, sClass) => {
    if(sClass){
        ...
        date.setTime(date.getTime() + (365))
        let expires = "expires=" + date.toUTCString()
        document.cookie = sName + "=" + sValue + ";" + expires + ";path=/; max-age=31536000; SameSite=None; Secure;"
        console.log(document.cookie)
    }
}
